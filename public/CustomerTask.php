...
<div class="container">
	<br/>
      <h1>C Task</h1>
       <br/>
        <div class="row" id="center"><t id="font">Task <?php echo $id?></t>&nbsp&nbsp&nbsp<?php require_once('../src/rankstars.php') ;?> &nbsp&nbsp&nbsp<a href="CustomerTaskEdit.php"><button class="btn btn-primary outline" style="font-size:15px">Edit</button></a></div>
       <hr/>  
    ...
    <div id="center">
		...
		<div class="row">
			...
			<?php for($x=0;$x<3;$x++)
			{
				...
				echo '<div class="col-xs-4 col-sm-4"><a href="ApplyerPage.php"><i class="fa fa-user" style="font-size:36px"></i></a>';
				
				//include('../src/rankStarsSmall.php');
				echo '</div>';
			}
			?>
					</div>
